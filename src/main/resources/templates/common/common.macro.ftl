...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-lg">自动化测试平台</span>
		</a>
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "projectList">active</#if>" ><a href="${request.
					contextPath}/project"><i class="fa fa-circle-o text-red"></i> <span>项目管理</span></a></li>
                <li class="nav-click <#if pageName == "datatype">active</#if>" ><a href="${request
					.contextPath}/dataType"><i class="fa fa-circle-o text-red"></i> <span>数据类型管理</span></a></li>
				<#if LOGIN_IDENTITY.type == 1>
                    <li class="nav-click <#if pageName == "bizList">active</#if>" ><a href="${request.
						contextPath}/biz"><i class="fa fa-circle-o text-red"></i> <span>业务线管理</span></a></li>
					<li class="nav-click <#if pageName == "userList">active</#if>" ><a href="${request.
						contextPath}/user"><i class="fa fa-circle-o text-red"></i> <span>用户管理</span></a></li>
				</#if>
			</ul>
		</section>
		<!-- /.sidebar -->
...
<#--        Powered by <b>自动化测试</b> -->
		<div class="pull-right hidden-xs">
            <strong>
                <a href="https://hugfeature.github.io/Echo/" target="_blank" >丑牛的个人空间</a>&nbsp;
