	    ...
	    <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 pull-right">
                    <button class="btn btn-block btn-success" type="button" onclick="javascript:window.open
                            ('${request.contextPath}/dataType/addDataTypePage')" >+新增数据类型</button>
                </div>
            </div>
...
<script>
    // 业务线权限
    var superUser = <#if LOGIN_IDENTITY.type == 1 >true<#else>false</#if>;
    var permissionBiz = '${LOGIN_IDENTITY.permissionBiz!""}';
