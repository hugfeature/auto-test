                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <button class="btn btn-default btn-xs" type="button" onclick="javascript:window.location
                                    .href='${request.contextPath}/dataType/dataTypeDetail?dataTypeId=${dataType.id}'"
                            >返回详情页</button>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="name" placeholder="请输入数据类型名称" maxlength="100" value="${dataType.name}" >
                            </div>
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" name="bizId" >
                                    <#if bizList?exists && bizList?size gt 0>
                                        <#list bizList as biz>
                                            <option value="${biz.id}" <#if dataType.bizId==biz.id>selected</#if> >${biz.bizName}</option>
                                        </#list>
                                    </#if>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="about" placeholder="请输入数据类型描述" maxlength="200" value="${dataType.about}" >
                            </div>
                        </div>
                        ...
                        <#if dataType.fieldList?exists && dataType.fieldList?size gt 0>
                            <#list dataType.fieldList as field>
                                <div class="form-group queryParams_item" >
                                    ...
                                    <div class="col-sm-3 item">
                                        <select class="form-control select2_tag_new fieldDatatypeId" style="width: 100%;">
                                            <option value="${field.fieldDataTypeId}">${field.fieldDataType
                                                .name}</option>
                                        </select>
                                    </div>
